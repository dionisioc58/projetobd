...
<html lang="pt-br">
			...
			<div class="w3-bar w3-light-blue" id="myNavbar">
				...
				<div class="w3-text-white w3-display-right w3-margin-bottom">
			        ...
			        <?php if(isset($_SESSION['usuario'])) { 
						echo '<a href="logout.php" class="w3-bar-item w3-blue w3-button w3-hover-blue w3-round-large w3-margin-right">Sair</a>';
					} else {
						echo '<a href="login.php" class="w3-bar-item w3-blue w3-button w3-hover-blue w3-round-large w3-margin-right">Login</a>';
					} ?>
	...
	<body>
		...
		<div class="w3-content w3-display-container" w3-opacity-min style="max-width:100%; height:auto" id="home">
...
<!-- Container (Contact Section) -->
  <div class="w3-content w3-container w3-padding-32" id="contato">
